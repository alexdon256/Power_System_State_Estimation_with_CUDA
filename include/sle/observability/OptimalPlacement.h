...
public:
    ...
    Real computeObservabilityGain(const NetworkModel& network,
...
private:
    ...
    bool isObservableWithMeasurements(const NetworkModel& network,
                                     const std::set<BusId>& measurements);
    
    // Build observability matrix
    void buildObservabilityMatrix(const NetworkModel& network,
                                  const std::set<BusId>& measurements,
